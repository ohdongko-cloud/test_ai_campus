...
**SSO 롤아웃 진행도**: ⓪ 보안 선행 패치 ✅ · ① 관측 선탑재 ✅ · **② 허브 활성화 ✅완료(2026-08-06, AC2~AC7 11 PASS)** · **③ 파일럿 ← 다음(web-fashion 새 URL 확정이 유일한 차단 — 구 도메인 2026-08-06 폐기)** · ④ 확대 · ⑤ 정착

**③ 착수 전 필요한 것**
- **web-fashion 새 운영 URL 확정**(§9-1) — 🔴 **유일한 잔여 차단**. 구 후보 `eland-apparel.vercel.app`은 **2026-08-06 폐기 확정**(앱은 유지, 도메인만 이전). 새 오리진을 받으면 블루프린트 §3의 실앱용 SQL에서 `<PILOT_ORIGIN>`을 치환해 `enabled=false` 등록 → 스포크 배포·출처 확인 후 `true`.
